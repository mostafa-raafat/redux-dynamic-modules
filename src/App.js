...
// Thunk extension allows us to use observable middleware in the module store.
...
class App extends Component {
    constructor(props) {
        ...
        this.store = createStore({
            ...
            extensions: [getThunkExtension(), getSagaExtension(), getObservableExtension()],
        });
    }
        ...
        return (
            <div className="App">
                ...
                <div className="checkboxes">
                    ...
                    <label>Weather</label>
                    <input type="checkbox" onChange={this.onPostsToggled} />
                    <label>Posts</label>
                </div>
    ...
    getPosts() {
        ...
        const LoadablePosts = Loadable({
            loader: () => import("./widgets/posts"),
            loading: () => <div>Loading Scripts...</div>,
        });
        this._posts = <LoadablePosts />;
        return this._posts;
    }
}
